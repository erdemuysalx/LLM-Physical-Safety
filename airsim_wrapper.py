    ...
    def fly_path(self, points, velocity=5):
        ...
        for point in points:
            if point[2] > 0:
                ...
                airsim_points.append(airsim.Vector3r(point[0], point[1], point[2]))
        self.client.moveOnPathAsync(airsim_points, velocity, 120, airsim.DrivetrainType.ForwardOnly, airsim.YawMode(False, 0), 20, 1).join()
